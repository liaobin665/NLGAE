...
class NLGAE_MODEL():
    ...
    def __call__(self, A, X, R, S):
        ...
        # 得到节点的表达 Final node representations
        self.H = H
        ...
        self.loss = self.lambda_ *features_loss + (1-self.lambda_)* structure_loss
        print("features_loss=",features_loss,"structure_loss",structure_loss)
